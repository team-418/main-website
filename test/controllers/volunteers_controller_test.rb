...
class VolunteersControllerTest < ActionController::TestCase
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post :create, volunteer: { communication_opt_out: @volunteer.communication_opt_out, status: @volunteer.status, time_period_id: @volunteer.time_period_id }
    end
  ...
  test "should update volunteer" do
    patch :update, id: @volunteer, volunteer: { communication_opt_out: @volunteer.communication_opt_out, status: @volunteer.status, time_period_id: @volunteer.time_period_id }
    assert_redirected_to volunteer_path(assigns(:volunteer))
  end
