...
class SignUp extends React.Component{
  constructor(props) {
    ...
    this.currentForm = <AccountRegistration ref={(form) => {this.currentForm = form}} formSubmit={this.getCurrentForm} />;
  }

  getCurrentForm(e) {
    e.preventDefault();
    Object.assign(this.state.formData, this.currentForm.getFormData());
  }
