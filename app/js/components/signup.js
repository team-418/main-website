          ...
          <div className="account-type col-md-offset-2 col-md-4">
            ...
            <div className="account-types">
              <div className="account-type-input">
                ...
                <label>
                  <input type="radio" name="account_type" value="principal" onClick={this.switchAccountType} checked={this.state.accountType == 'principal'} />
                  &nbsp;Principal
                </label>
              </div>
              ...
              <div className="account-type-input">
                ...
                <label onClick={this.switchAccountType}>
                  <input type="radio" name="account_type" value="volunteer" onClick={this.switchAccountType} checked={this.state.accountType == 'volunteer'} />
                  &nbsp;Volunteer
                </label>
              </div>
            </div>
